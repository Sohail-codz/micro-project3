...
function allFooditems(){
  foodOriginalData.map(function chart(item){
    console.log(item)
  })
}
console.log("Function that shows all the Food items:")
allFooditems()

function itemwithVeggies(){
...
console.log("Function that shows all the Food items with category vegetables:")
itemwithVeggies()

function itemwithFruits(){
  foodOriginalData.filter(function chart(item){
...
console.log("Function that shows all the Food items with category Nuts:")
itemwithNuts()

function itemwithGrains(){
  foodOriginalData.filter(function chart(item){
...
console.log("Function that shows all the Food items with category Grains:")
itemwithGrains()

function itemwithDairies(){
  foodOriginalData.filter(function chart(item){
...
console.log("Function that shows all the Food items with category Dairy:")
itemwithDairies()

function itemwithCalabove100(){
  foodOriginalData.filter(function chart(item){
    if(item.calorie >= 100)
    {
     console.log(item)
...
console.log("Function that shows all the Food items with calories above 100:")
itemwithCalabove100()

function itemwithCalbelow100(){
  foodOriginalData.filter(function chart(item){
    if(item.calorie <= 100)
    {
     console.log(item)
...
console.log("Function that shows all the Food items with calories below 100:")
itemwithCalbelow100()
